...
void init_modified_version(){
  ...
  if(ThisTask == 0 && modified_gravity_active){
    printf("============================================\n");
    printf("Running with Modified Gravity, toy f(R) model \n");
    printf("============================================\n");
    printf("  n                       = %f\n", n_fR);
    printf("  Modified gravity active = %i\n", modified_gravity_active);
    printf("  Include screening       = %i\n", include_screening);
  ...
  double h;
  Toy_fR_Solve_Background(n_fR, Omegam, OmegaDE, Omegar, h0_fR, &h);
  ...
  if(ThisTask == 0 && modified_gravity_active){
    printf("Calling Toy f(R) Background Solver: \n");
    printf(" OmegaM = %f\n", Omega);
    printf(" OmegaR   = %f\n", Omegar);
    printf(" OmegaDE  = %f\n", OmegaDE);
    printf(" n        = %f\n", n_fR);
  ...
  if(ThisTask == 0 && modified_gravity_active){
    printf("============================================\n");
    printf("Running with VCDM model \n");
    printf("============================================\n");
    printf("  w0_VCDM                       = %f\n", w0_VCDM);
    printf("  Modified gravity active = %i\n", modified_gravity_active);
    printf("  Include screening       = %i\n", include_screening);
...
double hubble(double a){
  ...
  return sqrt( Omega/(a*a*a) + (1.0 - Omega) * exp( 6.0 * w0_VCDM * (1/sqrt(a)-1))/(a*a*a)); //Here VCDM
