...
ifeq ($(MACHINE),JOSEMACBOOK)
  CC = mpicc                                                     # Add your MPI compiler here
ifdef SINGLE_PRECISION
  FFTW_INCL = -I/Users/jose/project/fftw-3.3.10/include/
  FFTW_LIBS = -L/Users/jose/project/fftw-3.3.10/lib/ -lfftw3f_mpi -lfftw3f
else
  FFTW_INCL = -I/Users/jose/project/fftw-3.3.10/include/         # Add paths to your FFTW3 library here
  FFTW_LIBS = -L/Users/jose/project/fftw-3.3.10/lib/ -lfftw3_mpi -lfftw3
endif
  GSL_INCL  = -I/opt/homebrew/include/gsl/                       # Add paths to your GSL library here
  GSL_LIBS  = -L/opt/homebrew/lib/ -lgsl -lgslcblas
  MPI_INCL  = -I/opt/homebrew/include
  MPI_LIBS  = -L/opt/homebrew/lib/ -lmpi
endif
